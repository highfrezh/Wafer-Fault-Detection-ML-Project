    ...
    def trainingModel(self):
        ...
        try:
            ...
            for i in list_of_clusters:
                cluster_data=X[X['Cluster'] == i] # selecting all the rows of a perticular cluster
                ...
                #getting the best model for each of the clusters using hyper parameter tuning
                ...
                #Checking the best model accuracy
